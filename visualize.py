...
config_file  = '/home/c402/mountData/yang/IRRA_ours/logs/CUHK-PEDES/best/configs.yaml'
args = load_train_configs(config_file)
#print(args)
args.batch_size = 1024
args.training = False
device = "cuda"
test_img_loader, test_txt_loader,n = build_dataloader(args)
...
dataset = CUHKPEDES(root='/home/c402/mountData/yang/datasets/')
...
def plot_retrieval_images(query_id, image_ids, query_caption, image_paths, gt_img_path, fname="ui.png"):
    print(query_id)
    print(image_ids)
    print(query_caption)
    fig = plt.figure()
...
query_id, image_ids, query_caption, image_paths, gt_img_path = get_one_query_caption_and_result_by_id(3900, indices, qids, gids, captions, img_paths, gt_img_paths)
